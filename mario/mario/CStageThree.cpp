...
void CStageThree::Enter()
{
		...
		//AddObject(new CMonsterDog({ 200.f, 50.f, 211.f, 143.f }), OBJ_TYPE::ENEMY);
		AddObject(new CMonsterDragon({ 700.f, 250.f, 180.f, 206.f }), OBJ_TYPE::ENUMY);
		dynamic_cast<CMonsterDragon*>(m_arrObject[(UINT)OBJ_TYPE::ENUMY].front())->SetTarget(m_arrObject[(UINT)OBJ_TYPE::PLAYER].front());
		//AddObject(new CMonsterDog({ 200.f, 50.f, 211.f, 143.f }), OBJ_TYPE::ENEMY);
