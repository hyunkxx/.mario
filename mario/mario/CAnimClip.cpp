...
void CAnimClip::Play(HDC _hdc)
{
	...
	GdiTransparentBlt(_hdc
		, (float)(m_pOwner->GetX() + CScrollMgr::GetInst()->GetScrollX()) - (int)(m_vecAnim[m_iCurFrame].size.width *  0.5f)
		, (float)(m_pOwner->GetY() + CScrollMgr::GetInst()->GetScrollY()) - (int)(m_vecAnim[m_iCurFrame].size.height * 0.5f)
